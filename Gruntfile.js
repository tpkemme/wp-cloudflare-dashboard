    ...
    grunt.initConfig({
        ...
        sass: {
            dist: {
                ...
                files: { 'assets/css/wp-cloudflare-dashboard.css': 'assets/css/sass/styles.scss' }
            }
        },
        cssmin: { dist: { files: { 'assets/css/wp-cloudflare-dashboard.min.css': 'assets/css/wp-cloudflare-dashboard.css' } } },
        usebanner: {
            taskName: {
                options: {
                    position: 'top',
                ...
                files: { src: ['assets/css/wp-cloudflare-dashboard.min.css'] }
            }
        },
        eslint: {
            src: [
        ...
        uglify: {
            dist: {
                files: { 'assets/js/wp-cloudflare-dashboard.min.js': 'assets/js/wp-cloudflare-dashboard.js' },
